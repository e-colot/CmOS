...
#define RAM_SIZE 256
#define DISK_SIZE 16*1024
#define PAGE_SIZE 16
extern unsigned char FILE_ALLOCATION; // 0 = bitmap + FAT, 1 = Contiguous Allocation
...
// TESTS PARAMETERS
#define TEST_FILE_NBR 30
#define TEST_FILE_SIZE 200
#define MAX_MIN_ITR 5
